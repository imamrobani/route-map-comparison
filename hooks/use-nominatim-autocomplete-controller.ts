...
export type UseNominatimAutocompleteControllerState = {
  suggestions: NominatimPlaceSuggestion[];
  isLoading: boolean;
  error: string | null;
  search: (args: {
    query: string;
...
export const useNominatimAutocompleteController =
  (): UseNominatimAutocompleteControllerState => {
    const [suggestions, setSuggestions] =
      useState<NominatimPlaceSuggestion[]>([]);
